...
/// partitions.
/// <para>
/// Exists because "the process is up" is not a useful liveness signal for a consumer: a loop that is
/// deadlocked, or one that has been evicted from its consumer group, keeps the web host serving
/// happily — SignalR handshakes included — while pushing nothing. The liveness probe reads this
/// instead.
/// </para>
/// </summary>
