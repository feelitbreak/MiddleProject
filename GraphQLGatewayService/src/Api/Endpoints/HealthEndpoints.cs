namespace GraphQLGatewayService.Api.Endpoints;
...
/// <c>MapHealthChecks</c>, which writes only a bare status string. Plain HTTP because orchestrator
/// probes cannot speak GraphQL; <c>Query.health</c> is the same information for clients.
/// </summary>
...
{
    /// <summary>
    /// Maps the probes. Liveness answers only whether the host is up; readiness covers the
    /// database and the schema, without which the gateway can serve nothing.
    /// </summary>
